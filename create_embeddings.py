...
vector_linear_dict = {
    ...
    torch.load(os.path.join("/home/chris/Data/Projects/HF_CACHE/modules/transformers_modules/dunzhang/stella_en_1.5B_v5", f"{vector_linear_directory}/pytorch_model.bin")).items()
}
